...
const MovieDetail = ({navigation, route}: any) => {
  ...
  const movieImageUrl =
    route?.params?.movie?.image || require('../../assets/deadpool.jpg');

  console.log('Movies8 mounted, route.params=', route?.params);
  ...
  useEffect(() => {
    const moviesRef = dbRef(database, 'Movies8');
        ...
        <View style={styles.contentContainer}>
          <View style={styles.tagsContainer}>
            <View style={styles.tagWrapper}>
              <Text style={styles.tagText}>SCIENCE FICTION</Text>
            </View>
            <View style={styles.tagWrapper}>
